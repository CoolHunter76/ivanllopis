...
WIDGET = """<button id="ai-toggle" class="ai-toggle" aria-label="Abrir asistente">IA</button><section id="ai-panel" class="ai-panel" hidden><header><strong>Asistente de Ivan</strong><button id="ai-close" aria-label="Cerrar">×</button></header><div id="ai-messages"><p>Hola. Pregúntame por el perfil, tecnologías o proyectos publicados.</p></div><form id="ai-form"><textarea id="ai-input" maxlength="500" placeholder="Escribe una pregunta..." required></textarea><button>Enviar</button></form><small>IA local. Las respuestas pueden contener errores. No se guardan conversaciones.</small></section><link rel="stylesheet" href="/static/css/assistant.css"><script src="/static/js/assistant.js" defer></script>"""
