...
WIDGET = """<button id="ai-toggle" class="ai-toggle" aria-label="Abrir asistente">IA</button><div class="ai-companion" aria-hidden="true"><img src="/static/images/ai-assistant-companion.webp" alt="" loading="lazy"></div><section id="ai-panel" class="ai-panel" hidden><header><strong>Asistente de Ivan</strong><button id="ai-close" aria-label="Cerrar">×</button></header><div id="ai-messages"><p>Hola. Pregúntame por el perfil, tecnologías o proyectos publicados.</p></div><form id="ai-form"><textarea id="ai-input" maxlength="500" placeholder="Escribe una pregunta..." required></textarea><button>Enviar</button></form><small>IA local. Las respuestas pueden contener errores. No se guardan conversaciones.</small><div class="ai-powered"><span class="ai-powered-mark" aria-hidden="true">L</span><a href="https://www.llama.com/" target="_blank" rel="noopener noreferrer">Powered by Llama 3.2 by Meta</a></div></section><link rel="stylesheet" href="/static/css/assistant.css"><script src="/static/js/assistant.js" defer></script>"""
